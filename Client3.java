...
//		텍스트 필드와 전송 버튼에 ActionListener를 걸어준다.
	...
	public static void main(String[] args) {
		...
		try {
//			서버에 접속한다.
			client.socket = new Socket("192.168.7.10", 10004);
			client.message = "192.168.7.10 서버의 10004번 포트로 접속 시도<br>";
...
//		텍스트 필드에 데이터가 입력된 상태일 경우 메시지를 클라잉너트 채팅창에 표시하고 서버로 전송한다.
		if(str.length() > 0) {
//			입력한 메시지를 클라이언트 채팅창에 표시한다.
			message = "client >> " + message + "<br>" + str;
